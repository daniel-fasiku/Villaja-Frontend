  ...
  return (
    ...
    >
      ...
      {["frame-52", "variant-17"].includes(state.property1) && (
        <>
          <div className="icon-input-fields">
            <div className="frame-6">
              <img className="bx-search" alt="Bx search" src="/img/bx-search-2.svg" />
...
function reducer(state, action) {
  if (state.property1 === "default") {
    switch (action) {
      ...
      case "mouse_enter_599":
        return {
          property1: "tablets",
        };

      case "mouse_enter_601":
        return {
          property1: "frame-49",
        };

      case "mouse_enter_603":
        return {
          property1: "frame-50",
        };

      case "mouse_enter_605":
        return {
          property1: "frame-51",
        };
    }
  ...
  if (state.property1 === "phones") {
    switch (action) {
      ...
      case "mouse_enter_635":
        return {
          property1: "tablets",
        };

      case "mouse_enter_637":
        return {
          property1: "frame-49",
        };

      case "mouse_enter_639":
        return {
          property1: "frame-50",
        };

      case "mouse_enter_641":
        return {
          property1: "frame-51",
        };
    }
  ...
  if (state.property1 === "tablets") {
    switch (action) {
      ...
      case "mouse_enter_689":
        return {
          property1: "phones",
        };

      case "mouse_enter_691":
        return {
          property1: "tablets",
        };

      case "mouse_enter_693":
        return {
          property1: "frame-49",
        };

      case "mouse_enter_695":
        return {
          property1: "frame-50",
        };

      case "mouse_enter_697":
        return {
          property1: "frame-51",
        };
    }
  ...
  if (state.property1 === "frame-52") {
    switch (action) {
      ...
      case "mouse_enter_928":
        return {
          property1: "phones",
        };

      case "mouse_enter_930":
        return {
          property1: "tablets",
        };

      case "mouse_enter_932":
        return {
          property1: "frame-49",
        };

      case "mouse_enter_934":
        return {
          property1: "frame-50",
        };

      case "mouse_enter_936":
        return {
          property1: "frame-51",
        };
    }
