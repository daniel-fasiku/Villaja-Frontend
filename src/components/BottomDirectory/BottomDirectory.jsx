...
export const BottomDirectory = ({ property1, className }) => {
  return (
    <div className={`bottom-directory property-1-11-${property1} ${className}`}>
      <Logo
        className="logo-2"
      ...
      <div className="frame-2">
        ...
        />
        <TopMenuComp
          className={`${property1 === "seller-pov" ? "top-menu-comp-3" : "top-menu-comp-2"}`}
          divClassName={`${property1 === "seller-pov" ? "class-2" : "top-menu-comp-instance"}`}
          text={property1 === "seller-pov" ? "Contact" : "Privacy Policy"}
        />
        {property1 === "default" && (
          <>
            <TopMenuComp className="top-menu-comp-3" divClassName="top-menu-comp-instance" text="About" />
            <TopMenuComp className="top-menu-comp-3" divClassName="top-menu-comp-instance" text="Contact" />
            <TopMenuComp className="top-menu-comp-3" divClassName="top-menu-comp-instance" text="Careers" />
          </>
        )}
      </div>
    </div>
