...
export const NewOrderDash = () => {
  return (
    <div className="new-order-dash">
      <div className="div">
        <div className="frame">
          <div className="group">
        ...
        <div className="order-recieved-2">
          <div className="text-wrapper-16">Order Cancelled</div>
          <p className="text-wrapper-17">This order has been cancelled.</p>
          <div className="text-wrapper-18">08-May-2023 14:55pm</div>
          <img className="close" alt="Close" src="/img/close-1.svg" />
        </div>
        <img className="close-2" alt="Close" src="/img/close.svg" />
      </div>
    </div>
  );
};
