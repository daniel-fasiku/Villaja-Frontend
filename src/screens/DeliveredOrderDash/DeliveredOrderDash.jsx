...
export const DeliveredOrderDash = () => {
  return (
    <div className="delivered-order-dash">
      <div className="div">
        <div className="frame">
          <div className="group">
            ...
            <OrderStatus className="order-status-instance" property1="delivered" />
          </div>
        ...
        <div className="order-recieved-3">
          <div className="text-wrapper-16">Shipped</div>
          <p className="text-wrapper-17">Awesome. We will keep your customer updated.</p>
          <div className="text-wrapper-18">08-May-2023 14:55pm</div>
          <img className="vector-2" alt="Vector" src="/img/vector-3.svg" />
        </div>
        <div className="order-recieved-4">
          <div className="text-wrapper-16">Delivered</div>
          <p className="text-wrapper-17">This order has successfully been delivered.</p>
          <div className="text-wrapper-18">08-May-2023 14:55pm</div>
          <img className="vector-2" alt="Vector" src="/img/vector-2.svg" />
        </div>
        <img className="close" alt="Close" src="/img/close.svg" />
        <Buttons className="buttons-instance" property1="default-filled" text="GET HELP" />
      </div>
    </div>
  );
};
